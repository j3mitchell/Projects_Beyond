...
When deterministic extraction reports an incomplete result, ResumeATS asks the
extension to open the submitted URL, read the visible DOM, return to ResumeATS,
and submit the text through the existing Paste Job Description handler. You can
