...
- The target-job preview keeps `[descr1]` under ten words, limits list items to
  six words, labels minimum and preferred skills as `[skMin01]` and `[skMax01]`,
  and renders numeric compensation as two amounts plus a term.
